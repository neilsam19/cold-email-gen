...
class Chain:
    ...
    def write_mail(self, job, links):
        # create another prompt template for email
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Neil, a business development executive at AtliQ. AtliQ is an AI & Software Consulting company dedicated to facilitating
            ...
            Remember, you are Neil, BDE at AtliQ. 
        ...
        return res.content
        ## essentially what we did in the notebook